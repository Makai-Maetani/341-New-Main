function GetInfo() {
    ...
    cityName.innerHTML = "--Orem--";

fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=1abd21634ef125e842688f25cdfb277a')
...
function DefaultScreen(){
    document.getElementById("cityInput").defaultValue = "Orem";
    GetInfo();
}
